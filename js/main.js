...
function applyStationType(station, typeIndex) {
  ...
  // 保存旧数据用于迁移（textValues/textStyleValues 由 ensureStationTextValues 统一处理）
  ...
  // textValues 和 textStyleValues 先保留旧数据，由后续 ensureStationTextValues 迁移
